...
class QuantitativeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      Item(
        ...
        url: 'https://fiekraah.com/kamy-courses/',
      ),
      Item(
        title: 'المناهج',
        icon: Icons.menu_book_outlined,
        url: 'https://fiekraah.com/kamy/',
      ),
      Item(
        title: 'كويزات سريعة',
      ...
      Item(
        ...
        url:
            'https://fiekraah.com/%d8%aa%d8%ac%d9%85%d9%8a%d8%b9%d8%a7%d8%aa-%d9%83%d9%85%d9%8a/',
      ),
      Item(
        title: 'مستوى تقدمك',
      ...
      Item(
        ...
        url:
            'https://fiekraah.com/forums/forum/%d9%86%d9%82%d8%a7%d8%b4%d8%a7%d8%aa-%d8%a7%d9%84%d9%82%d8%b3%d9%85-%d8%a7%d9%84%d9%83%d9%85%d9%8a/',
      ),
    ];
